/* eslint-disable */
import {
  speckle_standard_vert
} from './shaders/SpeckleStandardMaterial-vert'
import {
  speckle_standard_frag
} from './shaders/SpeckleStandardMaterial-frag'
import {
...
class SpeckleStandardMaterial extends MeshStandardMaterial {
  ...
  constructor(parameters, defines = []) {
    ...
    this.vertProgram = speckle_standard_vert;
    this.fragProgram = speckle_standard_frag;
